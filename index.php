...
<div class="position-relative bg1" style="height: 100vh">
    <h1 class="position-absolute top-50 start-50 translate-middle text-center text-white fw-bold" style="font-family: marker;">
        ACTION<br>
        AND FUN<br>
        FOR KIDS
    </h1>
    <a href="#scrollen" class="position-absolute bottom-0 start-50 translate-middle">
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" class="bi bi-arrow-down-circle-fill text-light" viewBox="0 0 16 16">
...
<div class="container-lg py-2 py-sm-5 px-4">
    <div class="row row-cols-1 row-cols-sm-3 row-cols-lg-4 justify-content-center">
        <div class="col position-relative m-2 p-0">
            ...
            <a href="#" class="btn position-absolute bottom-0 start-0 m-2 px-3 py-2 bg-secondary bg-opacity-75 rounded-pill" style="backdrop-filter: blur(2px);">
                <span class="align-middle text-white fw-bold">Attraktionen</span>
            </a>
        </div>
        <div class="col position-relative m-2 p-0">
            <img src="img/birthday.png" class="rounded-4" width="100%" height="auto">
            <a href="#" class="btn position-absolute bottom-0 start-0 m-2 px-3 py-2 bg-primary bg-opacity-75 rounded-pill" style="backdrop-filter: blur(2px);">
                <span class="align-middle text-white fw-bold">Geburtstag</span>
            </a>
        </div>
        <div class="col position-relative m-2 p-0">
            <img src="img/news.png" class="rounded-4" width="100%" height="auto">
            <a href="#" class="btn position-absolute bottom-0 start-0 m-2 px-3 py-2 bg-info bg-opacity-75 rounded-pill" style="backdrop-filter: blur(2px);">
