...
<style>
    body {
        margin-top: 25vh;
        background-image: url(img/bereich/teufelsrad/teufelsradDimmed.jpg);
    }
</style>
...
<div class="modul">
    ...
    <div class="container-lg p-4 bg-white rounded-top" style="min-height: 66vh">
        ...
        <div class="row row-cols-1 row-cols-sm-3 justify-content-center">
            ...
            <a href="img/bereich/teufelsrad/teufelsrad2.jpg" class="col m-2 p-0" target="_blank"><img src="img/bereich/teufelsrad/teufelsrad2.jpg" class="rounded-4 shadow" alt="Bild von Attraktion" width="100%" height="auto"></a>
        </div>
    </div>
</div>
