...
<div class="modul">
    ...
    <div class="p-3 px-4 m-0 bg-secondary bg-opacity-75 text-center text-white rounded" style="max-width: 75%; font-family: marker; backdrop-filter: blur(7.5px);">
...
<div class="modul">
    <div class="container-lg d-flex justify-content-center p-0 pt-5">
        <div class="p-3 px-4 m-0 bg-secondary bg-opacity-75 text-center text-white rounded" style="max-width: 60%; font-family: marker; backdrop-filter: blur(7.5px);">
