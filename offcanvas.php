            ...
            <ul class="navbar-nav d-flex flex-column gap-3 mb-4">
                ...
                <li class="nav-item">
                    <a href="entdecken.php" class="btn px-5 py-3 w-100 bg-secondary bg-opacity-50 rounded-pill" style="backdrop-filter: blur(2px);">
                        <span class="align-middle text-white text-nowrap fs-1 fw-bold" style="font-family: marker;">Entdecken </span>
                ...
                <li class="nav-item">
                    <a href="#" class="btn px-5 py-3 w-100 bg-danger bg-opacity-50 rounded-pill" style="backdrop-filter: blur(2px);">
                        <span class="align-middle text-white text-nowrap fs-1 fw-bold" style="font-family: marker;">Service </span>
