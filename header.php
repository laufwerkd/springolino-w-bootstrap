            ...
            <nav class="navbar d-flex flex-row justify-content-between p-0">
                ...
                <ul class="navbar-nav d-flex flex-row gap-2">
                    <li class="nav-item d-none d-sm-block">
                        <a href="buchen.php" class="btn ps-4 pe-3 py-2 h-100 bg-primary bg-opacity-75 rounded-pill" style="backdrop-filter: blur(2px);">
                            <span class="align-middle text-white fs-5" style="font-family: marker;">Geburtstag</span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-balloon-fill align-middle text-white" viewBox="0 0 16 16">
