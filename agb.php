...
<div class="container-fluid position-relative bg2" style="height: 20vh">
    <div class="container-lg position-absolute top-50 start-50 translate-middle">
        <h1 class="text-center text-white" style="font-family: marker;">Allgemeines</h1>
    </div>
</div>
<div class="container-fluid">
    <div class="container-lg py-5">
...
<div class="container-fluid position-relative bg2" style="height: 20vh">
    <div class="container-lg position-absolute top-50 start-50 translate-middle">
        <h1 class="text-center text-white" style="font-family: marker;">Benutzung der Spielgeräte</h1>
    </div>
</div>
<div class="container-fluid">
    <div class="container-lg py-5 px-4">
...
<div class="container-fluid position-relative bg2" style="height: 20vh">
    <div class="container-lg position-absolute top-50 start-50 translate-middle">
        <h1 class="text-center text-white" style="font-family: marker;">Videoüberwachung / Unfallmeldung</h1>
    </div>
</div>
<div class="container-fluid">
    <div class="container-lg py-5 px-4">
...
<div class="container-fluid position-relative bg2" style="height: 20vh">
    <div class="container-lg position-absolute top-50 start-50 translate-middle">
        <h1 class="text-center text-white" style="font-family: marker;">Speisen / Getränke / Rauchen / Alkohol</h1>
    </div>
</div>
<div class="container-fluid">
    <div class="container-lg py-5 px-4">
...
<div class="container-fluid position-relative bg2" style="height: 20vh">
    <div class="container-lg position-absolute top-50 start-50 translate-middle">
        <h1 class="text-center text-white" style="font-family: marker;">Keinen Zutritt haben</h1>
    </div>
</div>
<div class="container-fluid">
    <div class="container-lg py-5 px-4">
