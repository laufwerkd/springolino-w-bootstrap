    ...
    <div class="container-lg p-4 bg-white rounded">
        <div class="dropdown mb-3">
            ...
            <ul class="dropdown-menu shadow">
                <li><a class="dropdown-item" href="#gotoIndoor">Indoor Bereiche</a></li>
    ...
    <div class="container-lg p-4 bg-white rounded">
        <div class="row row-cols-1 row-cols-sm-3 row-cols-xl-5 justify-content-center">
            ...
            <div class="col card m-2 p-0 bg-info bg-opacity-25 border-0 shadow">
                <img src="img/bereich/kleinkinder.jpg" class="card-img-top">
                <div class="p-3">
            ...
            <div class="col card m-2 p-0 bg-primary bg-opacity-25 border-0 shadow">
                <img src="img/bereich/kettenflieger.jpg" class="card-img-top">
                <div class="p-3">
            ...
            <div class="col card m-2 p-0 bg-danger bg-opacity-25 border-0 shadow">
                <img src="img/bereich/autoscooter.jpg" class="card-img-top">
                <div class="p-3">
            ...
            <div class="col card m-2 p-0 bg-info bg-opacity-25 border-0 shadow">
                <img src="img/bereich/rollrutsche.jpg" class="card-img-top">
                <div class="p-3">
            ...
            <div class="col card m-2 p-0 bg-danger bg-opacity-25 border-0 shadow">
                <img src="img/bereich/spidertower.jpg" class="card-img-top">
                <div class="p-3">
            ...
            <div class="col card m-2 p-0 bg-secondary bg-opacity-25 border-0 shadow">
                <img src="img/bereich/rollendeTonne.jpg" class="card-img-top">
                <div class="p-3">
            ...
            <div class="col card m-2 p-0 bg-primary bg-opacity-25 border-0 shadow">
                <img src="img/bereich/airhockey.jpg" class="card-img-top">
                <div class="p-3">
            ...
            <div class="col card m-2 p-0 bg-warning bg-opacity-25 border-0 shadow">
                <img src="img/bereich/ballkanone.jpg" class="card-img-top">
                <div class="p-3">
            ...
            <div class="col card m-2 p-0 bg-secondary bg-opacity-25 border-0 shadow">
                <img src="img/bereich/freifallRutsche.jpg" class="card-img-top">
                <div class="p-3">
            ...
            <div class="col card m-2 p-0 bg-info bg-opacity-25 border-0 shadow">
                <img src="img/bereich/teufelsrad.jpg" class="card-img-top">
                <div class="p-3">
            ...
            <div class="col card m-2 p-0 bg-primary bg-opacity-25 border-0 shadow">
                <img src="img/bereich/gastro.jpg" class="card-img-top">
                <div class="p-3">
            ...
            <div class="col card m-2 p-0 bg-info bg-opacity-25 border-0 shadow">
                <img src="img/bereich/lerncomputer.jpg" class="card-img-top">
                <div class="p-3">
            ...
            <div class="col card m-2 p-0 bg-black bg-opacity-25 border-0 shadow">
                <img src="img/bereich/vr.jpg" class="card-img-top">
                <div class="p-3">
