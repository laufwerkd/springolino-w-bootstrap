    ...
    <div class="container-lg p-5 bg-white rounded">
        <div class="row row-cols-1 row-cols-sm-3 row-cols-xl-5 justify-content-center">
            ...
            <div class="col card m-2 p-0 bg-info bg-opacity-25 border-0 shadow">
                <img src="img/kleinkinder.jpg" class="card-img-top">
                <div class="p-3">
            ...
            <div class="col card m-2 p-0 bg-danger bg-opacity-25 border-0 shadow">
                <img src="img/autoscooter.jpg" class="card-img-top">
                <div class="p-3">
            ...
            <div class="col card m-2 p-0 bg-info bg-opacity-25 border-0 shadow">
                <img src="img/rollrutsche.jpg" class="card-img-top">
                <div class="p-3">
            ...
            <div class="col card m-2 p-0 bg-danger bg-opacity-25 border-0 shadow">
                <img src="img/spidertower.jpg" class="card-img-top">
                <div class="p-3">
            ...
            <div class="col card m-2 p-0 bg-secondary bg-opacity-25 border-0 shadow">
                <img src="img/rollendeTonne.jpg" class="card-img-top">
                <div class="p-3">
            ...
            <div class="col card m-2 p-0 bg-primary bg-opacity-25 border-0 shadow">
                <img src="img/airhockey.jpg" class="card-img-top">
                <div class="p-3">
            ...
            <div class="col card m-2 p-0 bg-secondary bg-opacity-25 border-0 shadow">
                <img src="img/freifallRutsche.jpg" class="card-img-top">
                <div class="p-3">
            ...
            <div class="col card m-2 p-0 bg-info bg-opacity-25 border-0 shadow">
                <img src="img/teufelsrad.jpg" class="card-img-top">
                <div class="p-3">
            ...
            <div class="col card m-2 p-0 bg-primary bg-opacity-25 border-0 shadow">
                <img src="img/gastronomie.jpg" class="card-img-top">
                <div class="p-3">
            ...
            <div class="col card m-2 p-0 bg-info bg-opacity-25 border-0 shadow">
                <img src="img/lerncomputer.jpg" class="card-img-top">
                <div class="p-3">
            ...
            <div class="col card m-2 p-0 bg-black bg-opacity-25 border-0 shadow">
                <img src="img/vr.jpg" class="card-img-top">
                <div class="p-3">
