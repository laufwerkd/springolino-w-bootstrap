...
<div class="modul">
    ...
    <div class="container-lg p-4 bg-white bg-opacity-75 rounded" style="backdrop-filter: blur(15px);">
        <div class="d-flex flex-column justify-content-center gap-3">
            ...
            <a href="downloads.php" class="btn px-5 py-3 w-100 bg-danger rounded-pill shadow">
                <span class="align-middle text-white text-nowrap fs-4" style="font-family: marker;">Downloads </span><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-download ms-1 text-white" viewBox="0 0 16 16">
